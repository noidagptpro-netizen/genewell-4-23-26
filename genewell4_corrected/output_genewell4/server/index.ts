...
export function createServer() {
  ...
  app.get("/api/wellness/report-html/:analysisId", handleReportHTML);
  app.get("/api/wellness/generate-pdf/:analysisId", handleGeneratePDFOnDemand);
